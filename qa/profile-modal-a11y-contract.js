...
function makeRuntime(options) {
  ...
  const sandbox = {
    ...
    avatarCategory: () => 'all', avatarLocked: () => false, avatarCanvas: () => el('span','avatar-canvas','●'),
    currencyIcon: () => el('span','coin','💵'), saveRoster() {}, syncProfiles() {}, renderMe() {}, renderLeaderboard() {}, toast() {},
